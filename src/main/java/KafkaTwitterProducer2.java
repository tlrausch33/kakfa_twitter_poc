...
public class KafkaTwitterProducer2 {
    public static void main(String[] args) throws Exception {
        ...
        hashtags[1]="#QSI";
        hashtags[2]="#Edisun";
        String consumerKey ="Oq13xWUyOBv6w0kM4ioGU3AuJ";
        String consumerSecret = "P2M0RWaxe65pcmVepyBeYUpkT2jbTV43tjaOPsQEJCfc3RsCJJ";
        String accessToken = "923630134694961152-6nM1Fop4iSNWHVXeAB8srTSAEiz4bTL";
        String accessTokenSecret = "faU6dS3rDjjoayx2IfcmMSpOzGFAEuGJUCLrrMvPVy5qx";
        String topicName = "first_topic";
        String[] arguments = hashtags.clone();
